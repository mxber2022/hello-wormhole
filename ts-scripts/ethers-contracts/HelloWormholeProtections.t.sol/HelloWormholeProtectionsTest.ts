...
export interface HelloWormholeProtectionsTestInterface extends utils.Interface {
  functions: {
    ...
    "testGreetingFromWrongSender()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testGreetingFromWrongSender",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface HelloWormholeProtectionsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelloWormholeProtectionsTestInterface;
  ...
  callStatic: {
    ...
    testGreetingFromWrongSender(overrides?: CallOverrides): Promise<void>;
