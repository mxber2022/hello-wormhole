...
export interface HelloWormholeConfirmationTestInterface
  ...
  functions: {
    ...
    "performRegistrations()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "performRegistrations",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface HelloWormholeConfirmationTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelloWormholeConfirmationTestInterface;
  ...
  callStatic: {
    ...
    performRegistrations(overrides?: CallOverrides): Promise<void>;
