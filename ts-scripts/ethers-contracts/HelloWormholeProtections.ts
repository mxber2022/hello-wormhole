...
export interface HelloWormholeProtectionsInterface extends utils.Interface {
  functions: {
...
export interface HelloWormholeProtections extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelloWormholeProtectionsInterface;
