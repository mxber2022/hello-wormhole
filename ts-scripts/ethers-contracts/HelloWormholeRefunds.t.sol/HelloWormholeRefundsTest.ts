...
export interface HelloWormholeRefundsTestInterface extends utils.Interface {
  functions: {
    ...
    "testGreetingWithCrossChainRefund()": FunctionFragment;
    "testGreetingWithRefund()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testGreetingWithCrossChainRefund"
      | "testGreetingWithRefund"
      | "tokenBridgeSource"
      | "tokenBridgeTarget"
      | "wormholeSource"
      | "wormholeTarget"
  ...
  encodeFunctionData(
    functionFragment: "testGreetingWithCrossChainRefund",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testGreetingWithRefund",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface HelloWormholeRefundsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelloWormholeRefundsTestInterface;
  ...
  callStatic: {
    ...
    testGreetingWithCrossChainRefund(overrides?: CallOverrides): Promise<void>;

    testGreetingWithRefund(overrides?: CallOverrides): Promise<void>;
