...
export interface HelloWormholeRefundsInterface extends utils.Interface {
  functions: {
    "latestGreeting()": FunctionFragment;
    "quoteCrossChainGreeting(uint16)": FunctionFragment;
    "quoteCrossChainGreetingRefundPerUnitGasUnused(uint16)": FunctionFragment;
    "receiveWormholeMessages(bytes,bytes[],bytes32,uint16,bytes32)": FunctionFragment;
    "sendCrossChainGreeting(uint16,address,string,uint16,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "quoteCrossChainGreetingRefundPerUnitGasUnused"
  ...
  encodeFunctionData(
    functionFragment: "quoteCrossChainGreetingRefundPerUnitGasUnused",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface HelloWormholeRefunds extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelloWormholeRefundsInterface;
  ...
  functions: {
    ...
    quoteCrossChainGreetingRefundPerUnitGasUnused(
      targetChain: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { refundPerUnitGasUnused: BigNumber }>;
